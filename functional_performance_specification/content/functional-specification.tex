...
%\begin{figure}[!ht]%
%    \centering
%    \subfloat[\centering Landing Page]{\includegraphics[scale=0.3]{images/landing.png}}%
%    \qquad
%    \subfloat[\centering Temperature Page]{\includegraphics[scale=0.3]{images/temperature.png}}%
%    \qquad
%    \subfloat[\centering Soil Page]{\includegraphics[scale=0.3]{images/soil.png}}%
%    \qquad
%    \subfloat[\centering pH Page]{\includegraphics[scale=0.364]{images/pH.png}}%
