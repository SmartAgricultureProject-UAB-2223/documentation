...
\begin{figure}[!ht]%
    \centering
    \subfloat[\centering Connectivity Diagram]{{\includegraphics[scale=0.2]{images/connectingdiagram.png}}}%
    \qquad
    \subfloat[\centering Set up on NRF52840 board]{{\includegraphics[scale=0.1]{images/ConnectivityToBoard.jpeg}}}%
